...
from requirements.standards.validation_codes import ISPM_15_MARKS # Importa la lista técnica correcta
...
def validate_ispm15_compliance(is_wood_pallet, user_declared_marks):
    ...
    Alineado con el tono: 'Advertir suavemente', no bloquear.
    """
